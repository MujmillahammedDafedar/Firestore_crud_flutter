        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
             //   _image == null ?Text('Empty') : Image.file(_image),
                FlatButton(
  ...
  String randomTodo() {
    ...
    switch (randomNumber) {
      case 1:
        ...
        break;
      case 2:
        todo = 'Do work, never give up';
        break;
      case 3:
        todo = 'Do work never give up if you fail';
        break;
      default:
        todo = 'Do work never give up if you fail try again';
        break;
    }
    return todo;
  }
